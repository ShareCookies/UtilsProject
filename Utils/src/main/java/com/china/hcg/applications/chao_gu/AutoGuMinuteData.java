...
//        list.add(new GuInfo("000725","京东方a",5 * GuDataUtils.oneHundredMillion));
        //list.add(new GuInfo("002027","分众传媒",12 * GuMinuteDataUtils.oneHundredMillion,6F,5.9F));
        list.add(new GuInfo("000792","盐湖股份",15 * GuMinuteDataUtils.oneHundredMillion,null,24.33F));
...
//                }
                try {
                    ...
                    GuMinuteData.MinuteData minuteDataObj = GuMinuteData.minuteData(guInfo.getCode(),guInfo.getName());
