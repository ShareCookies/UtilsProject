 ...
 * https://www.freesion.com/article/7849694159/
 *
 * @author Benjamin su
 * QQ:506825719
 * Email:jiang506825719@qq.com
 * demo:
 *         List<String> strings = Arrays.asList("name","value");
 *         List<List<String>> strings2 = Arrays.asList(Arrays.asList("1.1","1.2"),Arrays.asList("2.1","2.2"));
 *         TextTable textTable = new TextTable(strings,strings2);
...
public class TextTable {
	...
	private Integer pringtTableRow=Integer.MAX_VALUE;
